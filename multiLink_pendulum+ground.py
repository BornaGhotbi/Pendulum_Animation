...
def SimWorld():
        ...
        gkp = 60
        gkd = 60
        g_y = link1.posn[1]-2.45
        link4Vel=np.cross(link4.omega,-rw4) + link4.vel
        gforce = np.array([0, gkp*(g_y-(link4.posn[1]-rw4[1]))-gkd*link4Vel[1],0])
        gtorque = -np.matmul(rtilda4, gforce)
        
        if (link4.posn[1]-rw4[1]) <= g_y and link4Vel[1] <0:
            contact = 1
        ...
        friction_wiw4 = np.cross(-link4.omega,np.matmul(interia4,link4.omega)) - kd*link4.omega + contact*gtorque
        ...
        b = np.array([0, mg1, 0,  friction_wiw1[0],  friction_wiw1[1],  friction_wiw1[2],
                      ...
                      0, mg4 - contact*gforce[1], 0,  friction_wiw4[0],  friction_wiw4[1],  friction_wiw4[2],
